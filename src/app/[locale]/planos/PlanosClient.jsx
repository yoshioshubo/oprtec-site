    ...
    <div>
      <div className="mt-6 flex flex-col items-center gap-3">
        <span className="inline-flex items-center gap-2 rounded-full bg-emerald-50 px-4 py-1.5 text-sm font-medium text-emerald-700 ring-1 ring-inset ring-emerald-200">
          {t("economize", { pct: ANNUAL_DISCOUNT_PCT })}
        </span>
              ...
              {anual && (
                <>
                  <p className="mt-1 text-xs text-slate-400">
                    {t("cobradoUmaVez", { valor: precoExibido * 12 })}
                  </p>
      ...
      <div className="mt-14">
        ...
        <p className="mt-1 text-sm text-slate-500">{t("incluidoSubtitulo")}</p>
